 ...
 * @author hp
 */
public class FindTourController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<RegistrationDTTour> result = dao.findTourByPrice(minprice, maxprice, departure, arrival);

            request.setAttribute("INFO", result);
        } catch (Exception e) {
            log("ERROR at Find Tour Controller: " + e.getMessage());
        } finally {
